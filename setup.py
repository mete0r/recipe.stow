...
@setup_dir
def get_version():
    from mete0r_recipe_stow import __version__
    return __version__
...
setup_info = {
    'name': 'mete0r.recipe.stow',
    'version': get_version(),
    'description': 'a buildout recipe to stow/unstow generated files',
    'long_description': readfile('README.rst') + readfile('CHANGES.rst'),

    'author': 'mete0r',
    'author_email': 'mete0r@sarangbang.or.kr',
    'license': 'GNU Affero General Public License v3 or later (AGPLv3+)',
    # 'url': 'https://github.com/mete0r/recipe.stow',

    'packages': [
        'mete0r_recipe_stow',
        'mete0r_recipe_stow.tests',
    ],
    'package_dir': {'': '.'},
    'install_requires': [
        'zc.buildout',
    ...
    'entry_points': {
        'zc.buildout': [
            'default = mete0r_recipe_stow.recipe:Recipe'
        ],
    },
    'classifiers': [
